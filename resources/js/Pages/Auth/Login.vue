            ...
            <section class="hidden lg:flex lg:w-1/2 xl:w-5/12 flex-col justify-between p-10 xl:p-14 border-r border-white/10">
                <div>
                    ...
                    <h1 class="mt-8 max-w-xl text-5xl xl:text-6xl font-black leading-[0.95] tracking-tight text-white">
                        Gestiona salas y reservas desde un solo acceso.
                    </h1>
                    <p class="mt-6 max-w-lg text-base xl:text-lg leading-8 text-slate-300">
                        Entra con tu correo institucional, reserva espacios y revisa tu historial sin salir de la plataforma.
                    </p>
                </div>

                <div class="grid grid-cols-2 gap-4 max-w-xl">
                    <div class="rounded-2xl border border-white/10 bg-white/6 backdrop-blur-md p-4">
                        <div class="text-2xl font-bold text-cyan-300">Salas</div>
                        <div class="mt-1 text-sm text-slate-300">Espacios listos para reservar</div>
                    </div>
                    <div class="rounded-2xl border border-white/10 bg-white/6 backdrop-blur-md p-4">
                        <div class="text-2xl font-bold text-emerald-300">Reservas</div>
                        <div class="mt-1 text-sm text-slate-300">Confirmación inmediata</div>
                    </div>
                </div>
            </section>
            ...
            <section class="w-full lg:w-1/2 xl:w-7/12 flex items-center justify-center px-4 sm:px-8 py-10">
                <div class="w-full max-w-md rounded-3xl border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_30px_100px_rgba(0,0,0,0.45)] p-8 sm:p-10">
                    <div class="mb-8 lg:hidden">
                        ...
                        <p class="mt-2 text-sm text-slate-400">Accede a tus salas, reservas y confirmaciones.</p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="mt-6 flex flex-col gap-3 border-t border-white/10 pt-5 sm:flex-row sm:items-center sm:justify-between">
                            <p class="text-sm text-slate-400">¿Todavía no tienes cuenta?</p>
                            <Link
                                :href="route('register')"
                                class="inline-flex justify-center rounded-2xl border border-cyan-400/30 bg-cyan-500/10 px-4 py-3 text-sm font-semibold text-cyan-200 transition hover:bg-cyan-500/20"
                            >
                                Crear cuenta
                            </Link>
                        </div>
